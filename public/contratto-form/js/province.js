// Array delle province italiane (sigla e nome completo)
...
const selectProvincia = document.getElementById("provincia");
    ...
    province.forEach(prov => {
        ...
        option.textContent = `${prov.nome} (${prov.sigla})`;
        selectProvincia.appendChild(option);
    });
        selectProvincia.addEventListener("change", function () {
            const selectedOption = selectProvincia.options[selectProvincia.selectedIndex];
            selectProvincia.options[selectProvincia.selectedIndex].textContent = selectedOption.value; 
        });
    });