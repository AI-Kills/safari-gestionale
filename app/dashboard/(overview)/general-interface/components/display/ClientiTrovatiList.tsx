      ...
      <CardContent>
        {clientiTrovati?.length > 0 ? (
                ...
                {showPreventiviClienteList && cliente.id === clienteDaAggiornare.id && (
                  <div key={cliente.id + 'preventiviClienteList'} className="ml-[400px] flex flex-col pt-0">
                    {preventiviClienteList.length > 0 ? (
                      preventiviClienteList.map((preventivo, i) => {
          ...
          <div className="text-center py-8 text-gray-500">
            ...
            <p className="text-sm">Prova a inserire nome, cognome o email per cercare i clienti esistenti</p>
          </div>
        )}
      </CardContent>
    </Card>
