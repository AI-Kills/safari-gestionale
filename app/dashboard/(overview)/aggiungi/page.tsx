...
import { PlusIcon, CircleStackIcon, CheckCircleIcon } from "@heroicons/react/24/outline";
  ...
  const addEntity = async () => {
    ...
    if (result.success) {
      ...
      showToast({
        ...
        message: `${selectedOption?.name || 'Entità'} "${newEntity.value}" aggiunta correttamente al database.`,
        duration: 4000
      });
